...
const Tshirts = ({products}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4 justify-center">
      {Object.keys(products).length===0 && <p> Sorry! T-Shirts are out of Stock. Stay Tunned...</p>}
      ...
      return<Link passHref={true} key={item._id} href={`/product/${products[item].slug}`}><div className="lg:w-1/4 md:w-1/2 p-4 w-full cursor-pointer">
        <a className="block relative  rounded overflow-hidden">
          <Image alt="ecommerce" className=" object-top w-full h-full block" src={liverpool} />
        </a>
        <div className="mt-4">
